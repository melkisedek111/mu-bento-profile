...
const Contact = () => {
    return (
        <section className="flex flex-wrap gap-7 lg:justify-between">
            <CustomCard className="flex flex-col gap-12 sm:w-full lg:w-[48.49%] 2xl:w-[60%]" data-aos="fade-right">
            ...
            <CustomCard className="flex sm:w-full justify-between items-center gap-12  lg:w-[48.49%] 2xl:w-[38.5%]" data-aos="fade-left">
